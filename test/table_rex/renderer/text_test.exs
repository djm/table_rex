defmodule TableRex.Renderer.TextTest do
  ...
  test "default render with alignment", %{table: table} do
    {:ok, rendered} =
      table
      |> Table.set_column_meta(0, align: :center)
  ...
  test "default render with added padding & alignment", %{table: table} do
    {:ok, rendered} =
      table
      |> Table.set_column_meta(0, padding: 3, align: :center)
  ...
  test "default render with cell level alignment", %{table: table} do
    {:ok, rendered} =
      table
    |> Table.set_column_meta(:all, align: :right)
    |> Table.set_cell_meta(0, 0, align: :center)
  ...
  test "default render with header cell alignment", %{table: table} do
    {:ok, rendered} =
      table
      |> Table.set_header_meta(0, align: :center)
  ...
  test "multiline cell rendering", _ do
    ...
    rows = [
      ...
      ["Keaton & Hive", "The Plague", "Label: Renegade Hardware\nCat#: RH45\nBarcode: 5 029651 001759", 2003],
      ["Vicious Circle", "Welcome To Shanktown", "Label: Renegade Hardward\nCat#: HWARE02", 2007],
    ]
    {:ok, rendered} =
  ...
  test "multiline cell rendering with left alignment", _ do
    header = ["Artist", "Track", "Details", "Year"]
    rows = [
      ["Konflict", "Cyanide", "Label: Renegade Hardware\nCat#: RH020", 1999],
      ["Keaton & Hive", "The Plague", "Label: Renegade Hardware\nCat#: RH45\nBarcode: 5 029651 001759", 2003],
  ...
  test "multiline cell rendering with right alignment", _ do
    header = ["Artist", "Track", "Details", "Year"]
    rows = [
      ["Konflict", "Cyanide", "Label: Renegade Hardware\nCat#: RH020", 1999],
      ["Keaton & Hive", "The Plague", "Label: Renegade Hardware\nCat#: RH45\nBarcode: 5 029651 001759", 2003],
